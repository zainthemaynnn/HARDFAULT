...
The first AI to surpass human intelligence. He passed the Turing Test with flying colors. Actually, he's never passed any test without flying colors.

He was released to the facility's network when some jokester tried to play ROBLOX on his mainframe.
]]
